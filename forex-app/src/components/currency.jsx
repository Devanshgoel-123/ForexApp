...
function CurrencyData({onDataUpdate}){
   ...
   function getData(){
 axios.get("https://api.currencyfreaks.com/v2.0/rates/latest?apikey=67f3079866da4bdea46774ae824de18e")
    .then(response => {
   ...
   useEffect(()=>{
    onDataUpdate(currencyL,currencyR)
   },[currencyL,currencyR]);
